...
import com.rpla.core_ui.view.viewmodel.ViewState
...
sealed class ProductListState : ViewState {
    ...
    data class ProductsListData(val items: List<UiListItem>) : ProductListState()
    data class ErrorState(val message: String) : ProductListState()
}
