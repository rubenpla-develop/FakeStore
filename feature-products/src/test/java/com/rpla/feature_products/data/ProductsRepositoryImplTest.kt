...
import com.rpla.feature_products.fixtures.ProductDtoFixtures.dto1
...
class ProductsRepositoryImplTest {
    ...
    @Test
    fun `when service returns dto list then repository returns mapped Product list`() = runTest {
        val dto = listOf(dto1())
        ...
        product.description shouldBe "Your perfect pack for everyday use and walks in the forest. Stash your laptop (up to 15\") in the padded sleeve, plus plenty of room for essentials."
    ...
    @Test
    fun `when service throws HttpException 404 then repository maps as ClientError`() = runTest {
        // Given
    ...
    @Test
    fun `when service throws HttpException 500 then repository maps as ServerError`() = runTest {
        // Given
